<?php 
	...
	$order_id = $_POST['o_id'];
	$sql = "SELECT `Tshirt_image`, `order_id`, `Full Name`, `Size`, `Quantity`, `Total`, `Method`, `Address`, `Mo number`, `date_time` FROM `purchase` WHERE order_id = $order_id;";
	...
	$html = "";
		...
		$html .= '<p><b>Address:&nbsp;&nbsp;&nbsp;</b><font>'.$array["Address"].'</font></p>';
		$html .= '<p><b>Mobile no:&nbsp;&nbsp;&nbsp;</b><font>'.$array["Mo number"].'</font></p>';
		$html .= '<p><b>Purchase-Date:&nbsp;&nbsp;&nbsp;</b><font>'.$array["date_time"].'</font></p>';
		$html .= '<div class="next">';
       	$html .= '<button class="explore"><span> <a href="../index.php" title="">Go Home </a></span></button>';
       	$html .= '</div>';
		$html .= '</div>';
		$html .= '</div>';
